...
Data pipeline:
  - All languages (English, Hindi, Telugu) use pre-built splits:
    idioms_structured/Splits/train.jsonl
    idioms_structured/Splits/dev.jsonl
    idioms_structured/Splits/test.jsonl
...
def build_dataset_for_split(split_name, data_dir, langs, seed=42):
    ...
    All languages (including Hindi and Telugu) use idioms_structured/Splits/
