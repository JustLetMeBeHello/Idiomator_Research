...
Usage:
    ...
    python -u notebooks/colab/run_language_ablation_matrix.py

Useful options:
    python -u notebooks/colab/run_language_ablation_matrix.py --only_combo en_es
    python -u notebooks/colab/run_language_ablation_matrix.py --only_system joint
    python -u notebooks/colab/run_language_ablation_matrix.py --keep_checkpoints
...
Rerun after a code fix (idempotency hard rule — stale "✓ skip" is NOT success):
    ...
    python -u notebooks/colab/run_language_ablation_matrix.py --force --only_combo en_es
    python -u notebooks/colab/run_language_ablation_matrix.py --force --only_system bio
...
def cmd_for(args: argparse.Namespace, job: Job) -> list[str]:
    ...
    if job.system == "stage1":
        return [
            py, "-u", "training/Stage_1_training.py",
            *common,
    ...
    if job.system == "stage2":
        return [
            py, "-u", "training/Stage_2_training.py",
            *common,
    ...
    if job.system == "sequential":
        return [
            py, "-u", "training/Train_Sequential.py",
            *common,
    ...
    if job.system == "bio":
        return [
            py, "-u", "experiments/ablations/BiO_Task_mBERT_train.py",
            *common,
