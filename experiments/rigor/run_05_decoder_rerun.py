...
The bug: `decode_bio_to_char_span` in experiments/ablations/BiO_Task_mBERT_train.py
...
Usage:
    python experiments/rigor/run_05_decoder_rerun.py
"""
import json
...
OUT_DIR = REPO / "experiments/rigor/results"
...
def decode_buggy(bio_preds, encoding, sentence):
    """Verbatim copy of experiments/ablations/BiO_Task_mBERT_train.py:decode_bio_to_char_span."""
