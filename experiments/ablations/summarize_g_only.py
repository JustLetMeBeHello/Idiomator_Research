...
Two Drive directories:
  ...
  QA systems:     IdiomBERT_experiments/ablations/results/<combo>/
...
Usage (Colab, from repo root):
    python experiments/ablations/summarize_g_only.py \
        --g_dir   /content/drive/MyDrive/Idiomator_Research/results/language_ablation_matrix \
        --qa_dir  /content/drive/MyDrive/IdiomBERT_experiments/ablations/results

Usage (local — pass explicit paths if Drive is mounted or results are downloaded):
    python experiments/ablations/summarize_g_only.py --g_dir /path/g --qa_dir /path/qa
...
def main():
    ...
    parser.add_argument("--qa_dir", default=None,
        help="Path to IdiomBERT_experiments/ablations/results/ containing per-combo QA JSONs. "
             "Drive path: /content/drive/MyDrive/IdiomBERT_experiments/ablations/results")
