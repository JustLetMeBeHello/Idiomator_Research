...
Usage:
  .venv/bin/python3 Additional_Rigor_Experiments/sample_error_analysis.py
  .venv/bin/python3 Additional_Rigor_Experiments/sample_error_analysis.py \
      --n_per_cat 8 --seed 99
"""
...
def main():
    ...
    ap.add_argument('--output_dir', default=str(ROOT / 'Additional_Rigor_Experiments/results'))
    args = ap.parse_args()
