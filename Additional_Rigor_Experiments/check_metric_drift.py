...
Usage:
    python Additional_Rigor_Experiments/check_metric_drift.py
    python Additional_Rigor_Experiments/check_metric_drift.py --add <glob> ...
...
DEFAULT_TARGETS = [
    "Additional_Rigor_Experiments/*.sh",
    "Additional_Rigor_Experiments/*.ipynb",
    "CLAUDE.md",
    "Additional_Rigor_Experiments/CLAUDE.md",
]
