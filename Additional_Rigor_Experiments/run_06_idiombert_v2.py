...
Usage (single full-config run on EN+ES+HI+TE, evaluated on all five):
    python Additional_Rigor_Experiments/run_06_idiombert_v2.py \
...
Notes
-----
- The existing Train_Join.py architecture (mBERT + cls_head + start_head +
...
def parse_args():
    ...
    # ── Base trainer args (same defaults as Train_Join.py) ──
